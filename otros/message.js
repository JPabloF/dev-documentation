var message = (function () {
    ...
    var renderWidgetWithData = function() {
        ...
        try {            
            ...
            $('.mx-message').append( tmplList({ list: _.where(filteredData) }) );            
    ...
    function renderWidget(){
        apiUrl = $('.mx-message').first().data('url');
        ajaxCall();
    ...
    function animateWidget() {
        ...
        if ($(".mx-message .element li:only-child" ).parent().removeClass("element").addClass("element-single") ); 

          var ticker = $('.mx-message ul.element');
...
/*Widget Size*/
var myContainer = $(".mx-message").parent();
